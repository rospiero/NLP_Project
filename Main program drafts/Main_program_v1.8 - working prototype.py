...
top_batteries = scorer.get_top_products_by_category('Batteries', top_k=3)


# Generate summaries (will automatically handle low-data scenarios)
batteries_summary_file = generate_summary(top_batteries, df_combined, "Batteries_Summary.csv")
